Feature: Maestro de Ciudades
	Como		Cliente front
	Quiero		Un endpoint REST
	Para		listar las diferentes Marcas

Scenario: Maestro Ciudad - Peticion exitosa
	...
	When Realizo una llamada GET al Request URI "/api/city"
	Then Recibo un código de respuesta http "200"
	And  Recibo un arreglo de objetos mayor o igual a  "0"
	And Termino prueba

Scenario: Maestro Ciudad - Sin token de autorización válido
